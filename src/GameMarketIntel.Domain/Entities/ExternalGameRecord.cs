...
public sealed class ExternalGameRecord
{
        ...
        DateTimeOffset? sourceUpdatedAt = null)
    {
        ...
        {
            throw new ArgumentException("The data source ID is required.", nameof(dataSourceId));
        }
        ...
        DateTimeOffset? sourceUpdatedAt = null)
    {
        ...
        var normalizedSourceUpdatedAt = NormalizeTimestamp(
            sourceUpdatedAt.Value,
            nameof(sourceUpdatedAt));

        if (!SourceUpdatedAt.HasValue ||
            normalizedSourceUpdatedAt > SourceUpdatedAt.Value)
        {

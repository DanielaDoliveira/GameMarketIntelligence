...
public sealed class ExternalKeywordRecordConfiguration : IEntityTypeConfiguration<ExternalKeywordRecord>
{
    public void Configure(EntityTypeBuilder<ExternalKeywordRecord> builder)
    {
        builder.ToTable("external_keyword_records");
        ...
        builder.Property(record => record.ExternalId)
            ...
            .HasMaxLength(ExternalKeywordRecord.MaxExternalIdLength)
            .IsRequired();

        builder.Property(record => record.KeywordId)
        ...
        builder.HasOne<Keyword>()
            .WithMany()
            .HasForeignKey(record => record.KeywordId)
            .OnDelete(DeleteBehavior.Restrict);
    }
}
...
namespace GameMarketIntel.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260824142147_RemoveGameImageUrl")]
    partial class RemoveGameImageUrl
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameMarketIntel.Domain.Entities.GameImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ExternalGameRecordId");

                    b.HasIndex("GameId");

                    b.HasIndex("ExternalGameRecordId", "ExternalId", "Type")
                        .IsUnique();
